...
from shell_runner import bash_argv, run_process
...
def run_bash(command: str) -> str:
    ...
    try:
        r = run_process(bash_argv(command), cwd=WORKDIR, timeout=120)
...
class BackgroundManager:
    ...
    def _exec(self, tid: str, command: str, timeout: int):
        try:
            r = run_process(bash_argv(command), cwd=WORKDIR, timeout=timeout)
